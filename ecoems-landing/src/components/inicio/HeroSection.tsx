  ...
  return (
    <section className="max-w-6xl mx-auto px-6 pt-4">
      <div className="rounded-[2rem] overflow-hidden relative min-h-[360px] md:min-h-[440px]" style={{ backgroundColor: '#472E18' }}>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center px-6 md:px-14 py-10 md:py-16 gap-6 md:gap-8">
          <div className="max-w-2xl space-y-5 flex-1">
            <h1
            ...
            <p
              className="text-secondary-foreground/75 text-sm md:text-base max-w-md leading-relaxed opacity-0 animate-fade-up"
            ...
            <div className="opacity-0 animate-fade-up" style={{ animationDelay: '0.5s' }}>
              <button
                ...
                className="px-5 py-3 rounded-full font-semibold text-xs sm:text-sm transition-all duration-200 shadow-lg hover:scale-105 hover:shadow-xl active:scale-95 text-left sm:text-center"
          ...
          <div
            className="flex-shrink-0 flex items-center justify-center opacity-0 animate-fade-in hidden sm:flex"
