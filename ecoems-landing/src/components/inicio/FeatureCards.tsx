...
const features = [
  {
    ...
    description:
      "Descubre técnicas reales para estudiar mejor, entender más rápido y dejar de perder tiempo.",
  },
  {
    icon: ClipboardList,
    title: "Aplica mientras estudias",
    description:
      "No es teoría. Usas los métodos directamente en tus sesiones de estudio.",
  },
  {
    icon: Users,
    title: "Mejora todos los días",
    description:
      "Ve tu progreso, ajusta tu forma de estudiar y empieza a notar resultados reales.",
  },
];
