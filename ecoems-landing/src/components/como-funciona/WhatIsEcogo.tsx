      ...
      <AnimateOnScroll animation="fade-up">
        ...
        >
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#472E18' }}>¿Qué es ECOGO?</h2>
            <p className="text-base leading-relaxed max-w-xl mb-10 text-justify" style={{ color: '#472E18', opacity: 0.8 }}>
              ECOGO es una app de estudio diseñada para estudiantes que quieren entrar al nivel medio
              superior a través del ECOEMS 2026. Estamos construyendo la herramienta que reúne todo
              lo que necesitas en un solo lugar: práctica, seguimiento y estrategia, para que llegues
              preparado el día del examen. Próximamente disponible — regístrate y sé de los primeros en acceder.
            </p>
            <button
