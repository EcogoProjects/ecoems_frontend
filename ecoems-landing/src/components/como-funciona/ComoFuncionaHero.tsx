  ...
  return (
    <section
      ...
      style={{
        ...
        minHeight: "clamp(320px, 50vw, 460px)",
      }}
    >
      <div
        className="absolute hidden [@media(min-width:1507px)]:block"
        style={{
          bottom: "140px",
          left: "5%",
          zIndex: 20,
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col items-center text-center gap-6 md:gap-8 pt-12 md:pt-16 pb-20 md:pb-36">
        ...
        >
          Prepárate de forma inteligente, práctica y sin estrés con la app
          diseñada para aspirantes a nivel medio superior. Aprende lo que
          realmente viene en el examen y mejora tus resultados desde hoy.
        </p>
        <div
