        ...
        >
          <div className="flex-1 space-y-6">
            ...
            <p
              ...
              style={{ color: "#EEE4C1", opacity: 0.6 }}
            >
              Este método te permite avanzar de forma progresiva y segura, sin
              sentirte abrumado y con claridad sobre tu progreso en todo
              momento.
            </p>
          </div>
