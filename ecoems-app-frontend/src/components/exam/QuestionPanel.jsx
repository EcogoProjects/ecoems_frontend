        ...
        <div className="bg-base w-full p-4 md:p-6 rounded-[18px] md:col-span-2 md:h-full shadow-lg">
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="text-lg font-semibold pt-1 text-slate-800">
                    <LatexParagraph content={currentQ.question} />
                </div>
            </div>

            <div className={`pl-2.5 mt-6 ${areAllImages ? 'flex flex-col gap-2.5 min-[900px]:grid min-[900px]:grid-cols-2 min-[900px]:gap-4' : 'flex flex-col gap-2.5'}`}>
                {options.map((opt) => {
