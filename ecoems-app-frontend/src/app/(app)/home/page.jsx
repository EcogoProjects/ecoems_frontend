...
function HomePage() {
    ...
    return (
        ...
        />*/}
            <ExamSelector />
            <div className="flex flex-col-reverse gap-2 md:grid md:grid-cols-3 w-4/5 md:gap-4">
                {/*Contenedor izquierdo grid */}
                <div className="bg-white rounded-box-standard shadow-lg p-10 pl-3.5 pr-3.5
