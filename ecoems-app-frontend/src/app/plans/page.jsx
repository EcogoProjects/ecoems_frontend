            ...
            <div className="flex flex-col md:flex-row gap-5 md:items-start">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <ul>
                        ...
                        <li className="flex items-center justify-start gap-2">
                            <IoIosCloseCircle  size={20} color="#b33e36"/><p>Sin acceso a exámenes personalizados.</p>
                        </li>
                        <li className="flex items-center justify-start gap-2">
                            <IoIosCloseCircle size={20} color="#b33e36"/><p>Sin acceso a los exámenes simulacro.</p>
                        </li>
                        <li className="flex items-center justify-start gap-2">
                ...
                <div className="flex flex-col items-center gap-4 md:border-l-2 pt-2.5 md:pt-0 md:pl-4.5">
                    ...
                    <button className="bg-premium-box text-white rounded-full p-3 pr-6 pl-6 cursor-pointer">
                        ¡Obtener ahora!
                    </button>
                    <ul>
                        <li className="flex items-center justify-start gap-2">
                        ...
                        <li className="flex items-center justify-start gap-2">
                            <IoIosCheckmarkCircle size={20}/><p>Acceso a exámenes personalizados.</p>
                        </li>
                        <li className="flex items-center justify-start gap-2">
                            <IoIosCheckmarkCircle size={20}/><p>Acceso a los exámenes simulacro.</p>
                        </li>
                        <li className="flex items-center justify-start gap-2">
