    ...
    */
    ...
    return ( 
        ...
        ">
            ...
            md:grid md:grid-cols-3 md:max-w-4/5 md:min-h-[500px]
            ">
                {/*Contenedor con pregunta y respuestas*/}
                <div className="bg-base  max-w-4/5 p-3 pt-4 rounded-[18px]
                md:col-span-2 md:w-full md:max-w-full md:h-full">
